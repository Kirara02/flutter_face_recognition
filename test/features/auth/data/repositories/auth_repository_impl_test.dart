...
import 'package:flutter_face_recognition/core/base/result.dart';
import 'package:flutter_face_recognition/features/auth/data/datasources/auth_local_datasource.dart';
import 'package:flutter_face_recognition/features/auth/data/datasources/auth_remote_datasource.dart';
import 'package:flutter_face_recognition/features/auth/data/models/requests/login_request.dart';
import 'package:flutter_face_recognition/features/auth/data/repositories/auth_repository_impl.dart';
import 'package:flutter_face_recognition/features/auth/domain/entities/user.dart';
...
void main() {
  ...
  final testResponse = {
    ...
    'user': {'id': 1, 'name': 'Test', 'username': 'test', 'role': 'User'},
  };
