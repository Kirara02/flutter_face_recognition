...
import 'package:flutter_face_recognition/features/auth/domain/repositories/auth_repository.dart';
import 'package:flutter_face_recognition/features/auth/domain/usecases/login_usecase.dart';
...
void main() {
  ...
  test(
    'should return Success when repository login status is success',
    () async {
      // arrange
      when(
